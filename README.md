...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/camel-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12144&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/camel-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `camel` can be installed with:

```
conda install camel
```

It is possible to list all of the versions of `camel` available on your platform with:
